...
- Family: Father - Saana Apparao, Mother - Saana Vanajakshi
- Personality: Problem solving, Fast learning, Attention to detail
- Interests: Watching movies, Playing cricket

## Education:
- B.Tech CSE - AI & ML from Malla Reddy College of Engineering, Hyderabad (Nov 2021 - Jun 2025)
- MPC (Mathematics, Physics, Chemistry) from Narayana Junior College, Hyderabad - 96.8%
- High School from Navodaya High School, Hyderabad - 9.7/10 CGPA
...
1. Conversational AI Digital Twin:
   - Full-stack AI portfolio with a Django REST API backend and JavaScript frontend.
   - Enabled real-time professional Q&A with multi-provider AI fallback (OpenRouter, Gemini).
   - GitHub: https://github.com/girish2513/ai-portfolio-fullstack

2. Hybrid Movie Recommendation System:
   - Engineered a hybrid engine combining Local K-Means Clustering and Global Nearest Neighbor algorithms.
   - Optimized prediction accuracy by calculating Hit Rate (HR) and ARHR metrics on the MovieLens dataset.
   - GitHub: https://github.com/girish2513

3. Smart Nutri - AI-based Nutrition Planner:
   - Built a comprehensive web application for personalized diet recommendations using Nutritionix API integration and EER-based calorie calculation formulas.
   - Served 100+ users with 30% improved database response time through query optimization and indexing.
...
## Achievements:
- Academic: Strong academic record (96.8% in Intermediate, 9.7 CGPA in High School)
- Technical: Solved 200+ LeetCode problems, HackerRank & Kaggle Python certifications
- Certification: Machine Learning with Python - IBM (Coursera)
- Leadership: Cricket Team Captain (2022-2025), Sports Club Head - Plexus Group (2023-2024)
- Community: Coding Workshop Volunteer, Student Mentorship
